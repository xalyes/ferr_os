...
qemu-system-x86_64 -drive format=raw,file=target/x86_64-unknown-uefi/debug/loader.gdt -bios build/OVMF_CODE.fd -monitor vc:2560x1440 -m 128M -d int -D log.txt -no-reboot
