...
"-bios", current_dir + "/build/OVMF_CODE.fd", "-rtc", "base=localtime,clock=rt", "-icount", "shift=5", "-smp", "2", "-device", "isa-debug-exit,iobase=0xf4,iosize=0x04", "-serial", "stdio", "-no-reboot"] + sys.argv[2:])
