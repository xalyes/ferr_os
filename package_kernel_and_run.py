...
"-bios", current_dir + "/build/OVMF_CODE.fd", "-rtc", "base=localtime,clock=vm", "-icount", "shift=9", "-smp", "2", "-device", "isa-debug-exit,iobase=0xf4,iosize=0x04", "-serial", "stdio", "-no-reboot"] + sys.argv[2:])
